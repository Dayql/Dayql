...
- 🔗 Building AI-integrated workflows with **n8n** and custom APIs
- 💬 Internal chatbots and assistants integrated into business tools
- ⚙️ Process automation with **Python** scripts (ERP, reporting, data sync)
- 🧠 LLM integration (OpenAI, Anthropic) into existing information systems
